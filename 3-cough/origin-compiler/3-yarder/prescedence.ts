...
const precedenceDictionary: OperatorInterface[] = [
  ...
  { operator: "<~", precedence: 0, affix: Affix.INFIX},
  { operator: ":", precedence: 0, affix: Affix.INFIX },
  { operator: "and", precedence: 2, affix: Affix.INFIX },
  { operator: "or", precedence: 2, affix: Affix.INFIX },
  { operator: "=", precedence: 3, affix: Affix.INFIX },
  { operator: "<", precedence: 3, affix: Affix.INFIX },
  { operator: ">", precedence: 3, affix: Affix.INFIX },
  { operator: "+", precedence: 4, affix: Affix.INFIX },
  { operator: "-", precedence: 4, affix: Affix.INFIX },
  { operator: "*", precedence: 4, affix: Affix.INFIX },
  { operator: "/", precedence: 4, affix: Affix.INFIX },
  { operator: "%", precedence: 4, affix: Affix.INFIX },
  ...
  { operator: "|", precedence: 4, affix: Affix.INFIX },
  { operator: "^", precedence: 4, affix: Affix.INFIX },
  { operator: "++", precedence: 5, affix: Affix.SUFFIX },
  { operator: "--", precedence: 5, affix: Affix.SUFFIX },
  { operator: "~~", precedence: 5, affix: Affix.SUFFIX },
  { operator: "!!", precedence: 5, affix: Affix.SUFFIX },
  { operator: "not", precedence: 5, affix: Affix.PREFIX },
];
